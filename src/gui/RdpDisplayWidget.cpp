...
void RdpDisplayWidget::keyPressEvent(QKeyEvent* e) { emit keyInput(qtKeyToVirtualKey(static_cast<Qt::Key>(e->key())),true,e->isAutoRepeat()); }
void RdpDisplayWidget::keyReleaseEvent(QKeyEvent* e) { emit keyInput(qtKeyToVirtualKey(static_cast<Qt::Key>(e->key())),false,e->isAutoRepeat()); }
void RdpDisplayWidget::focusOutEvent(QFocusEvent* e) { QWidget::focusOutEvent(e); }
}
